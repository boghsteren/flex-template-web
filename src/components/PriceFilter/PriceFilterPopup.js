  ...
  render() {
    ...
    const label = hasInitialValues
      ? intl.formatMessage(
          ...
          {
            minPrice: unitProps==='currency' ?
                      formatCurrencyMajorUnit(intl, currencyConfig.currency, minPrice)
                      : unitProps==='$' ? unitProps + minPrice : minPrice + unitProps,
            maxPrice: unitProps==='currency' ? 
                      formatCurrencyMajorUnit(intl, currencyConfig.currency, maxPrice)
                      : unitProps==='$' ? unitProps + maxPrice : maxPrice + unitProps,
          }
        )
