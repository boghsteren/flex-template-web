...
class FieldTimeInputComponent extends Component {
  render() {
    ...
    if (touched && error && hideError) {
      handleGetBookingDateTimeError ? handleGetBookingDateTimeError(errorComp, 'bookingTime') : null;
    } else {
      handleGetBookingDateTimeError ? handleGetBookingDateTimeError(null, 'bookingTime') : null;
    }
